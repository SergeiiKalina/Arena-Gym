...
function PopUpCoach({ showPopUp, currentIndex, coachArray }) {
  ...
  return (
    <section className="pop_up_coach_wrapper" onClick={(e) => showPopUp(e, 0)}>
      <article className="pop_up_coach" id="popUpCoach">
        ...
        <div className="pop_up_coach_slider_wrapper" ref={wrapperSliderBlock}>
          {coachArray.map((coach) => (
            ...
            >
              <img
                src={`data:image/jpeg;base64,${coach.img}`}
                alt={coach.name}
              />
              <div className="pop_up_item_description">
                <div className="description_name">{coach.name}</div>
